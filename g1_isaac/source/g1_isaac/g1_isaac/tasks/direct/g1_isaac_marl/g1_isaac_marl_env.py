...
from .g1_isaac_marl_env_cfg import G1IsaacMarlEnvCfg


class G1IsaacMarlEnv(DirectMARLEnv):
    cfg: G1IsaacMarlEnvCfg

    def __init__(self, cfg: G1IsaacMarlEnvCfg, render_mode: str | None = None, **kwargs):
